							...
							success: function(result){
										...
										swal({
											...
											closeOnConfirm: false
												...
												window.location.href = "loginDepart.jsp";
											}
										);
									}
        ...
        if($(this).is("#password")){
         ...
         if($(this).is("#code")){
            if(re.test(this.value)){
                ...
                $.ajax({
						type: "POST",
						url: "../universal/checkCodeValidate",
						dataType: "HTML",
						data: {'code':$("#code").val()},   
						success:function(result){
									if(result == "success"){
...
//        alert("success");
        $.ajax({
			type: "POST",
			url: "/association/administrator/adminLogin",
			dataType: "HTML",
			...
			success: function(result){
        				if(result == "success"){
							...
							closeOnConfirm: false
								...
								window.location.href = "/association/admin/admin_index.jsp";
							}
						);
        				}else if(result == "none"){
        					swal({
