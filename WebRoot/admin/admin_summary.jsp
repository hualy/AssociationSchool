...
<div class="container-fluid">
    <div class="row">
        ...
        <div  class="right">
            ...
            <div class="content">
                <div class="contentHeader"><p>部门活动 > （往期）活动总结</p></div>
                <button class="edit createOldActivity" data-target="#createActivityModal" data-toggle="modal">添加活动</button>
                <div class="oldActivityContent">
                    <div class="activityHeader">
                        <p class="oldActivityName">院运会</p>
                        <p class="oldActivityTime">2016.11.12</p>
                        <p class="oldActivityTip">|&nbsp;&nbsp;双击编辑</p>
                    </div>
...
<div class="modal fade" id="createActivityModal" tabindex="-1" role="dialog" aria-labelledby="myModal" aria-hidden="true">
    <div class="modal-dialog summaryDialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" accept-charset="utf-8" class="modalForm">
                    <div class="row editform">
                        <div><label >活动名</label><input type="text" name="activityName" value="" id="activityName" class="required"></div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="submitBtn" id="summaryBtn">提交</button>
            </div>
        </div>
    </div>
</div>
...
<script src="../js/adminJS/admin_summary.js"></script>
</body>
</html>
