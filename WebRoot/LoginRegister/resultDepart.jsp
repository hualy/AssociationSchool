...
<html>
  ...
  <div class="alert-body">
    ...
    <a id="js-alert-btn" class="alert-btn" href="http://localhost:8080/association/LoginRegister/loginDepart.jsp">立即前往登录</a> </div>
   	...
   	<script>
		function alertSet(e) {
		    ...
		    setInterval(function() {
		        if (0 == t){
					location.href="http://localhost:8080/association/LoginRegister/loginDepart.jsp";
				}else {
		            t -= 1,
		            document.getElementById("js-sec-text").innerHTML = t;
